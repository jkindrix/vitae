...
export default {
  metadata: {
    description:
      'Dark-mode resume with luminous violet-blue accents for digital-first submission',
    author: 'Vitae',
    version: '1.0.0',
    license: 'MIT',
    tags: ['single-column', 'dark-mode', 'modern', 'luminous'],
  },
  filters: [
    {
      name: 'initials',
  ...
  helpers: (resume) => ({
    ...
    skillCount: (resume.skills ?? []).reduce(
